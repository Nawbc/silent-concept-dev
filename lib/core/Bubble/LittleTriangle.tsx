...
// // import { prefix } from './';
// import './style/littleTriangle.scss';

// const prefix = 's-bubble';

// export const LittleTriangle = function() {
// 	return <div className={`${prefix}-triangle`} />;
// };
...
// type placeType =
// 	| ['right' | 'left' | 'top' | 'bottom', 'left' | 'middle' | 'right']
// 	| ['right' | 'left' | 'top' | 'bottom'];

// type BubbleContent = string | React.ReactChild | object;
...
// 			if ('visible' === vision) who.style.transform = `translate${direction}(-4px)`;
// 			else who.style.transform = `translate${direction}(4px)`;
// 		};
...
// 					} else {
// 						execVisible('visible');
// 						if (duration! > 0) currentTimeout = setTimeout(execVisible, duration, 'hidden');
// 					}
// 				});
// 			}
// 		}
...
// 		return (
// 			<div ref={this.bubbleRef} className={className.wrapperName}>
// 				<div className={e ? className.triangleName : className.contentName}>
// 					{e ? null : icon ? <Icon src={icon}></Icon> : null}
// 					{e ? null : content}
// 				</div>
// 				<div className={e ? className.contentName : className.triangleName}>
// 					{e ? icon ? <Icon src={icon}></Icon> : null : null}
// 					{e ? content : null}
// 				</div>
// 			</div>
// 		);
